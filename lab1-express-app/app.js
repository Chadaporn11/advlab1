...
//เรียกฟLงก:ชัน expressFunction() ซึ่งผลลัพธ:จะไดUกลับมาเปVนออบเจ็กต: แลUวนําไปเก็บยังตัวแปร express
...
//เรียกใชUเมธอด get เพื่อตรวจสอบพาธที่ส]งมาพรUอมกับ HTTP Request โดยกําหนด Endpoint
expressApp.get('/api/resource', function (req, res) {
    Students.findOne({ id: "B6218560" }, (err, data) => {
        res.send(data)
    });
});
